...
from torch_geometric_temporal.dataset.StaticClassificationDatasetLoader import StaticClassificationDatasetLoader


class StaticClassificationDatasetLoaderTests(unittest.TestCase):

    # TODO merge into StaticDatasetLoaderTests for less duplicated code

    def test__get_targets_and_features_with_offset_1(self):
        loader = StaticClassificationDatasetLoader("Resources/test_data_classifier.json")
        loader.get_dataset(input_window=2, offset=3, standardize=False)

        expected_features = [[[0, 1], [1, 2], [0, 1]]]
        expected_targets = [[0, 1, 0]]
    ...
    def test_get_dataset_splitting_3(self):
        loader = StaticClassificationDatasetLoader("Resources/test_data_classifier_v2.json")
